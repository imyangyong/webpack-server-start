...
(function () {
    ...
    while (length--) {
        ...
        if (!console[method]) {
            ...
            // native code in ie9 can't set `apply`
            console[method] = (function (origin) {
                return function () {
        ...
        if (!console[method].apply) {
            console[method].apply = function (_, argv) {
                console[method](argv);
            };
        }
    ...
    (function (e) {
        ...
        function r(e, t) {
            if (!e) {
                throw new Error('Failed to construct ' + t + ': 1 argument required, but only 0 present.')
            }
        }
        function i(e) {
            if (e.length === 1) {
        ...
        for (var o, u, a, f, l, c = e.document, h = Object.prototype.hasOwnProperty, p = Object.defineProperty || function (e, t, n) {
                    ...
                    return function (n) {
                        var r,
                            ...
                            f = this.parentNode;
                        if (f) {
                            for (s = this.getAttribute('id') || y, o = s === y ? s : s.replace(B, j), a = n.split(','), i = 0; i < a.length; i++) {
                                a[i] = '#' + o + ' ' + a[i];
                    ...
                    var n = this,
                        r;
                    while ((r = n && n.matches) && !n.matches(t)) {
                        n = n.parentNode;
                    }
                    return r ? n : null;
                }, 'prepend', function () {
        ...
        try {
            ...
            z = function (e) {
                function t(e, t) {
                    r(arguments.length, 'Event');var n = c.createEvent('Event');
        ...
        try {
            ...
            z = function (t) {
                function a(e) {
                    for (var t = [], n = ['ctrlKey', 'Control', 'shiftKey', 'Shift', 'altKey', 'Alt', 'metaKey', 'Meta', 'altGraphKey', 'AltGraph'], r = 0; r < n.length; r += 2) {
                        e[n[r]] && t.push(n[r + 1]);
                ...
                function h(t, o) {
                    r(arguments.length, 'KeyboardEvent'), o = f(o || {}, i);var u = c.createEvent(s),
                        h = o.ctrlKey,
                        p = o.shiftKey,
                        d = o.altKey,
                        v = o.metaKey,
                    ...
                    if ('initKeyEvent' in u) {
                        u.initKeyEvent(t, x, T, k, h, d, p, v, E, S);
                    }
                    ...
                    for (y in u) {
                        i.hasOwnProperty(y) && u[y] !== o[y] && l(y, u, o);
                    }
                    return u;
                }
                var n = 0,
        ...
        try {
            ...
            z = function (t) {
                function n(t, n) {
                    r(arguments.length, 'MouseEvent');var i = c.createEvent('MouseEvent');
        ...
        function r(e, t, n) {
            function i(e) {
                i.once && (e.currentTarget.removeEventListener(e.type, t, i), i.removed = !0), i.passive && (e.preventDefault = r.preventDefault), typeof i.callback == 'function' ? i.callback.call(this, e) : i.callback && i.callback.handleEvent(e), i.passive &&
                ...
                return function (s, o, u) {
                    if (u && typeof u != 'boolean') {
                        var a = i.get(this),
                            ...
                            p,
                            d;
                        a || i.set(this, a = new n), s in a || (a[s] = {handler: [], wrap: []}), p = a[s], l = c.call(p.handler, o), l < 0 ? (l = p.handler.push(o) - 1, p.wrap[l] = d = new n) : d = p.wrap[l], f in d || (d[f] = r(s, o, u), e.call(this, s, d[f], d[f].capture));
                    }
                    else {
                        e.call(this, s, o, u);
                    }
                    ...
                    if (s && typeof s != 'boolean') {
                        ...
                        if (o && n in o) {
                            ...
                            if (-1 < a) {
                                u = h(s), l = f.wrap[a];
                                if (u in l) {
                                    e.call(this, n, l[u], l[u].capture),
                                    delete l[u];
                                    for (u in l) {
                                        return;
                                    }
                                    f.handler.splice(a, 1), f.wrap.splice(a, 1), f.handler.length === 0 &&
                                    delete o[n];
                                }
                            }
                        }
    ...
    // https://raw.githubusercontent.com/mylovecompany/ie9-js/master/ie9.min.js
    ...
    // // https://github.com/gdi2290/ie-shim/blob/master/dist/browser.min.js
    // !function(t){function e(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return t[i].call(r.exports,r,r.exports,e),r.loaded=!0,r.exports}var n={};return e.m=t,e.c=n,e.p="",e(0)}([function(t,e){/*! @source http://stackoverflow.com/questions/6903762/function-name-not-supported-in-ie*/
    //     Object.hasOwnProperty("name")||Object.defineProperty(Function.prototype,"name",{get:function(){var t=this.toString().match(/^\s*function\s*(\S*)\s*\(/),e=t&&t.length>1?t[1]:"";return Object.defineProperty(this,"name",{value:e}),e}}),/*! @source https://github.com/ModuleLoader/es6-module-loader/blob/master/src/url-polyfill.js*/
    //         function(t){function e(t,n){if("string"!=typeof t)throw new TypeError("URL must be a string");var i=String(t).replace(/^\s+|\s+$/g,"").match(/^([^:\/?#]+:)?(?:\/\/(?:([^:@\/?#]*)(?::([^:@\/?#]*))?@)?(([^:\/?#]*)(?::(\d*))?))?([^?#]*)(\?[^#]*)?(#[\s\S]*)?/);if(!i)throw new RangeError;var r=i[1]||"",o=i[2]||"",s=i[3]||"",a=i[4]||"",c=i[5]||"",l=i[6]||"",h=i[7]||"",u=i[8]||"",f=i[9]||"";if(void 0!==n){var d=n instanceof e?n:new e(n),p=""===r&&""===a&&""===o;p&&""===h&&""===u&&(u=d.search),p&&"/"!==h.charAt(0)&&(h=""!==h?(""===d.host&&""===d.username||""!==d.pathname?"":"/")+d.pathname.slice(0,d.pathname.lastIndexOf("/")+1)+h:d.pathname);var w=[];h.replace(/^(\.\.?(\/|$))+/,"").replace(/\/(\.(\/|$))+/g,"/").replace(/\/\.\.$/,"/../").replace(/\/?[^\/]*/g,function(t){"/.."===t?w.pop():w.push(t)}),h=w.join("").replace(/^\//,"/"===h.charAt(0)?"/":""),p&&(l=d.port,c=d.hostname,a=d.host,s=d.password,o=d.username),""===r&&(r=d.protocol)}"file:"==r&&(h=h.replace(/\\/g,"/")),this.origin=r+(""!==r||""!==a?"//":"")+a,this.href=r+(""!==r||""!==a?"//":"")+(""!==o?o+(""!==s?":"+s:"")+"@":"")+a+h+u+f,this.protocol=r,this.username=o,this.password=s,this.host=a,this.hostname=c,this.port=l,this.pathname=h,this.search=u,this.hash=f}t.URLPolyfill=e}("undefined"!=typeof self?self:global),"document"in self&&!("classList"in document.createElement("_"))&&!function(t){"use strict";if("Element"in t){var e="classList",n="prototype",i=t.Element[n],r=Object,o=String[n].trim||function(){return this.replace(/^\s+|\s+$/g,"")},s=Array[n].indexOf||function(t){for(var e=0,n=this.length;n>e;e++)if(e in this&&this[e]===t)return e;return-1},a=function(t,e){this.name=t,this.code=DOMException[t],this.message=e},c=function(t,e){if(""===e)throw new a("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(e))throw new a("INVALID_CHARACTER_ERR","String contains an invalid character");return s.call(t,e)},l=function(t){for(var e=o.call(t.getAttribute("class")||""),n=e?e.split(/\s+/):[],i=0,r=n.length;r>i;i++)this.push(n[i]);this._updateClassName=function(){t.setAttribute("class",this.toString())}},h=l[n]=[],u=function(){return new l(this)};if(a[n]=Error[n],h.item=function(t){return this[t]||null},h.contains=function(t){return t+="",-1!==c(this,t)},h.add=function(){var t,e=arguments,n=0,i=e.length,r=!1;do t=e[n]+"",-1===c(this,t)&&(this.push(t),r=!0);while(++n<i);r&&this._updateClassName()},h.remove=function(){var t,e=arguments,n=0,i=e.length,r=!1;do{t=e[n]+"";var o=c(this,t);-1!==o&&(this.splice(o,1),r=!0)}while(++n<i);r&&this._updateClassName()},h.toggle=function(t,e){t+="";var n=this.contains(t),i=n?e!==!0&&"remove":e!==!1&&"add";return i&&this[i](t),!n},h.toString=function(){return this.join(" ")},r.defineProperty){var f={get:u,enumerable:!0,configurable:!0};try{r.defineProperty(i,e,f)}catch(d){-2146823252===d.number&&(f.enumerable=!1,r.defineProperty(i,e,f))}}else r[n].__defineGetter__&&i.__defineGetter__(e,u)}}(self),window.console||(window.console={}),window.console.log||(window.console.log=function(){}),window.console.error||(window.console.error=function(){}),window.console.warn||(window.console.warn=function(){}),window.console.assert||(window.console.assert=function(){}),/*! @author Paul Irish */
    //         /*! @source https://gist.github.com/paulirish/1579671 */
    //         function(){var t=0;window.requestAnimationFrame||(window.requestAnimationFrame=function(e,n){var i=Date.now(),r=Math.max(0,16-(i-t)),o=window.setTimeout(function(){e(i+r)},r);return t=i+r,o}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(t){clearTimeout(t)})}()}]);

}());

// polyfill.herokuapp.com/core
// !function(t){function e(t){var e=null;return function(){return null===e&&(e=t()),e}}function r(t){if(Object.keys)return Object.keys(t);var e=[];for(var r in t)t.hasOwnProperty(r)&&e.push(r);return e}function n(t){for(var e=[],r=0,n=t.length;n>r;r++){var o=t[r];e.indexOf(o)<0&&e.push(o)}return e}function o(t){var e=document.createElement("script"),r=document.getElementsByTagName("head")[0];e.type="text/javascript",e.src=t,r.appendChild(e)}var i="http://polyfill.herokuapp.com/resource",u="http://polyfill.herokuapp.com/polyfill",a=[],s={json:{test:function(){return window.JSON&&"string"==typeof window.JSON.stringify(1)}},localstorage:{test:function(){return!!window.localStorage},prereqs:["json"]},placeholder:{test:function(){var t=document.createElement("input");t.type="text";var e="placeholder"in t;return t=null,e}},queryselectorall:{test:function(){return!!document.querySelectorAll}},requestanimationframe:{test:function(){return!!window.requestAnimationFrame}},classlist:{test:function(){return!1 in document.createElement("a")}},hashchange:{test:function(){return"onhashchange"in window}},eventsource:{test:function(){return"EventSource"in window},prereqs:["xhr"]},xhr:{test:function(){return!!window.XMLHttpRequest}},promise:{test:function(){return!!window.Promise},prereqs:["setimmediate"]},foreach:{test:function(){return!!Array.prototype.forEach}},indexof:{test:function(){return!!Array.prototype.indexOf}},filter:{test:function(){return!!Array.prototype.filter}},map:{test:function(){return!!Array.prototype.map}},every:{test:function(){return!!Array.prototype.every}},some:{test:function(){return!!Array.prototype.some}},reduce:{test:function(){return!!Array.prototype.reduce}},reduceright:{test:function(){return!!Array.prototype.reduceRight}},lastindexof:{test:function(){return!!Array.prototype.lastIndexOf}},trim:{test:function(){return!!String.prototype.trim}},bind:{test:function(){return!!Function.prototype.bind}},toisostring:{test:function(){return!!Date.prototype.toISOString},prereqs:["dateparse"]},keys:{test:function(){return!!Object.keys}},isarray:{test:function(){return!!Array.isArray}},now:{test:function(){return!!Date.now}},dateparse:{test:function(){return!isNaN(Date.parse("2011-06-15T21:40:05+06:00"))}},getprototypeof:{test:function(){return!!Object.getPrototypeOf}},setimmediate:{test:function(){return"function"==typeof window.setImmediate}}};t.needs=function(e,i){function u(t){for(var e=0,r=t.length;r>e;e++)c(t[e].toLowerCase())}function c(t){var e=s[t];if(!e)throw new Error('Polyfill "'+t+'" not found');switch(e.state){case"untested":e.test()?e.state="unneeded":(e.state="loading",f.push(e.name),u(e.prereqs));break;case"loading":f.push(e.name),u(e.prereqs)}}"string"==typeof e&&(e=e.split(",")),"*"===e[0]&&(e=r(s));var f=[];return u(e),f=n(f),f.length?("function"==typeof i&&a.push({needed:f,callback:i}),void o(t.polyfillUrl(f))):void("function"==typeof i&&i())},t.loaded=function(e){s[e].state="loaded",t.testCallbacks()},t.testCallbacks=function(){for(var e=0;e<a.length;e++){var r=a[e];t.areLoaded(r.needed)&&a.splice(e--,1)[0].callback()}},t.areLoaded=function(t){for(var e=0,r=t.length;r>e;e++)if("loaded"!==s[t[e]].state)return!1;return!0},t.resourceUrl=function(t){var e=i;return t&&(e+="?f="+t),e},t.polyfillUrl=function(t){var e=u;return t&&(e+="?p="+t.join(",")),e},t.ie=function(){for(var t,e=3,r=document.createElement("div"),n=r.getElementsByTagName("i");r.innerHTML="<!--[if gt IE "+ ++e+"]><i></i><![endif]-->",n[0];);return e>4?e:t}();var c=function(t,r){this.name=t,this.state="untested",this.test=e(r.test),this.prereqs=r.prereqs||[]};for(var f in s)s.hasOwnProperty(f)&&(s[f]=new c(f,s[f]))}(window.Polyfill={});
